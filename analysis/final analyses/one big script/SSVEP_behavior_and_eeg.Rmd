...
# for (i in 1:length(plottingConditions)){
#   
#   if(plottingConditions[i]=="Attended"){dataAmplitudePlot=subset(dataPlot,Attention=="Attended")
...
#   
#   
#   #  if(plottingConditions[i]=="Attended"){posterior_means_plot=subset(posterior_means,Attention=="Attended")}
#   # if(plottingConditions[i]=="Attended"){posterior_conditions_plot=subset(posterior_conditions,Attention=="Attended")}
#   
#   
#   else if(plottingConditions[i]=="Unattended"){dataAmplitudePlot=subset(dataPlot,Attention=="Unattended")
...
#   
  # 
  # if(plottingConditions[i]=="Unattended"){posterior_means_plot=subset(posterior_means,Attention=="Unattended")}
  # if(plottingConditions[i]=="Unattended"){posterior_conditions_plot=subset(posterior_conditions,Attention=="Unattended")}
  
  
  # Violin + the model
  # if(plottingConditions[i]=="Attended"){tiff("ssvep_attended.tiff", units="in", width=8, height=5, res=800)}
  # 
  # if(plottingConditions[i]=="Unattended"){tiff("ssvep_unattended.tiff", units="in", width=8, height=5, res=800)}
