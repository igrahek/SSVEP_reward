...
# phaseANDattention = readRDS("phaseANDattention.EEG.allsubs.rds")
# rewardTimesPhasePlusAtt = readRDS("rewardTimesPhasePlusAtt.EEG.allsubs.rds")
model.full.threefactors = readRDS("full.EEG.allsubs.attcc.rds")
compare.threefactors.EEG.waic = readRDS("compare.EEG.waic.allsubs.attcc.rds")
#compare.EEG.waic.weights = readRDS("compare.EEG.waic.weights.attcc")
bR2.null.EEG = readRDS("bR2.null.attcc.EEG")
bR2.expphase.EEG = readRDS("bR2.expphase.attcc.EEG")
bR2.attention.EEG = readRDS("bR2.attention.attcc.EEG")
bR2.phaseANDattention.EEG = readRDS("bR2.phaseANDattention.attcc.EEG")
bR2.phaseANDattention_interaction.EEG = readRDS("bR2.phaseANDattention_interaction.attcc.EEG")
bR2.rewardTimesPhasePlusAtt.EEG = readRDS("bR2.rewardTimesPhasePlusAtt.attcc.EEG")
bR2.full.EEG = readRDS("bR2.full.attcc.EEG")
```
...
pp_check(model.full.threefactors, "error_scatter_avg")
```
...
coefplot(model.full.threefactors)
# conditions = data.frame(Attention = c(0.5, -0.5))
...
#   post[["b_ConditionLow_Rew:ExpPhaseAcq:Attention"]]
# 
# ##################### Not Attended
# 
# ######### High reward
...
#   post[["b_ConditionLow_Rew:ExpPhaseExt:Attention"]] 
# ##################### Not Attended
# 
# ######### High reward
...
```{r, warning=FALSE, message=FALSE}
# Diff_Bsln_Acq_Low_NotAtt = Baseline_Low_NotAttended - Acquisition_Low_NotAttended
...
```{r, warning=FALSE, message=FALSE}
# Diff_Acq_Ext_Low_Att = Acquisition_Low_Attended - Extinction_Low_Attended
...
```{r, warning=FALSE, message=FALSE}
# Diff_Acq_Ext_High_NotAtt = Acquisition_High_NotAttended - Extinction_High_NotAttended
...
```{r, warning=FALSE, message=FALSE}
# Diff_Acq_Ext_Low_NotAtt = Acquisition_Low_NotAttended - Extinction_Low_NotAttended
