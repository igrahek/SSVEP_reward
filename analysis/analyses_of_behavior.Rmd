...
```{r, warning=FALSE, message=FALSE}
Diff_Bsln_Acq_High = Baseline_High - Acquisition_High
...
```{r, warning=FALSE, message=FALSE}
Diff_Bsln_Acq_Low = Baseline_Low - Acquisition_Low
...
```{r, warning=FALSE, message=FALSE}
Diff_Acq_Ext_High = Acquisition_High - Extinction_High
...
```{r, warning=FALSE, message=FALSE}
Diff_Acq_Ext_Low = Acquisition_Low - Extinction_Low
