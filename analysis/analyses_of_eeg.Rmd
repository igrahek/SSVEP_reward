...
```{r, warning=FALSE, message=FALSE}
Diff_Rew_Ext_Att = Extinction_High_Attended - Extinction_Low_Attended
plotPost(Diff_Rew_Ext_Att, xlab = "", col = "#b3cde0", cex = 1, showCurve = FALSE, compVal = 0)
```

Check the difference between high and low reward in basline not attended

```{r, warning=FALSE, message=FALSE}
Diff_Rew_Bsln_NotAtt = Baseline_High_NotAttended - Baseline_Low_NotAttended
plotPost(Diff_Rew_Bsln_NotAtt, xlab = "", col = "#b3cde0", showCurve = FALSE, cex = 1, compVal = 0)
```

Check the difference between high and low reward in acquisition not attended

```{r, warning=FALSE, message=FALSE}
Diff_Rew_Acq_NotAtt = Acquisition_High_NotAttended - Acquisition_Low_NotAttended
plotPost(Diff_Rew_Acq_NotAtt, xlab = "", col = "#b3cde0", cex = 1, showCurve = FALSE, compVal = 0)
```

Check the difference between high and low reward in extinction not attended

```{r, warning=FALSE, message=FALSE}
Diff_Rew_Ext_NotAtt = Extinction_High_NotAttended - Extinction_Low_NotAttended
plotPost(Diff_Rew_Ext_NotAtt, xlab = "", col = "#b3cde0", cex = 1, showCurve = FALSE, compVal = 0)
```
