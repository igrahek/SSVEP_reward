...
```{r, warning=FALSE, message=FALSE}
# Difference between high and low reward in acquisition not attended
Diff_Rew_Acq_NotAtt = Acquisition_High_NotAttended - Acquisition_Low_NotAttended
plotPost(Diff_Rew_Acq_NotAtt, xlab = "", col = "#b3cde0", cex = 1, showCurve = TRUE, ROPE = c(0,1))
...
h2 = hypothesis(post, "0 > b_ConditionLow_Rew  + b_ConditionLow_Rew:ExpPhaseAcq + b_ExpPhaseAcq:AttentionNotAtt + b_ConditionLow_Rew:ExpPhaseAcq:AttentionNotAtt")
print(h2)
plot(h2)
```