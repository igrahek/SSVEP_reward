...
posterior_conditions =  posterior_conditions %>% separate(variable, c("Reward_Phase", "Reward_Magnitude", "Attention"), "_", extra = "merge")
...
# Pirate plot
pirateplot(formula=Amplitude ~ Reward_Phase + Reward_Magnitude + Attention, # dependent~independent variables
           data=posterior_conditions, # data frame
           main="ssVEPs", # main title
           xlim=NULL, # x-axis: limits
           xlab="", # x-axis: label
