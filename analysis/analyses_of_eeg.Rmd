...
pacman::p_load(reshape2,yarrr,BayesFactor,plyr,ez,schoRsch,brms,knitr,broom, brmstools)
# set seed
set.seed(42)
...
```{r, warning=FALSE, message=FALSE}
coefplot(model.full.threefactors, type = "b")
...
```{r, warning=FALSE, message=FALSE}
coefplot(model.full.threefactors, type = "r")
```

## Plotting the best model

High reward attended (plot 1) and Low reward attended (plot 2)
...
plot(marginal_effects(model.full.threefactors, effects = "ExpPhase:Attention", conditions = conditions),ask=FALSE)
```