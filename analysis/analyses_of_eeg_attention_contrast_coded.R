...
pacman::p_load(reshape2,yarrr,BayesFactor,plyr,ez,schoRsch,brms,lme4, BEST, brmstools, MASS)
# set seed
set.seed(42) 
# import data
...
null = brm(Amplitude ~ 1 + (1|Subject),
                              ...
                              cores = 4,
                              sample_prior = TRUE)
saveRDS(null,file="null.EEG.allsub.attcc.rds")
...
expphase = brm(Amplitude ~ ExpPhase + (ExpPhase|Subject),
                                  ...
                                  cores = 4,
                                  sample_prior = TRUE)
saveRDS(expphase,file="expphase.EEG.allsubs.attcc.rds")
...
attention = brm(Amplitude ~ Attention + (Attention|Subject),
                                   ...
                                   cores = 4,
                                   sample_prior = TRUE)
saveRDS(attention,file="attention.EEG.allsubs.attcc.rds")
...
phaseANDattention = brm(Amplitude ~ ExpPhase + Attention + (ExpPhase + Attention|Subject),
                                        ...
                                        cores = 4,
                                        sample_prior = TRUE)
saveRDS(phaseANDattention,file="phaseANDattention.EEG.allsubs.attcc.rds")
...
phaseANDattention_interaction = brm(Amplitude ~ ExpPhase * Attention + (ExpPhase * Attention|Subject),
                        ...
                        cores = 4,
                        sample_prior = TRUE)
saveRDS(phaseANDattention_interaction,file="phaseANDattention_interaction.EEG.allsubs.attcc.rds")
...
rewardTimesPhasePlusAtt = brm(Amplitude ~ Condition * ExpPhase + Attention + (Condition * ExpPhase + Attention|Subject),
                         ...
                         cores = 4,
                         sample_prior = TRUE)
saveRDS(rewardTimesPhasePlusAtt,file="rewardTimesPhasePlusAtt.EEG.allsubs.attcc.rds")
...
full = brm(Amplitude ~ Condition * ExpPhase * Attention + (Condition * ExpPhase * Attention|Subject),
                              ...
                              cores = 4,
                              sample_prior = TRUE)
saveRDS(full,file="full.EEG.allsubs.attcc.rds")
...
# null = readRDS("null.EEG.allsub.attcc.rds")
# attention = readRDS("attention.EEG.allsubs.attcc.rds")
# expphase = readRDS("expphase.EEG.allsubs.attcc.rds")
# phaseANDattention = readRDS("phaseANDattention.EEG.allsubs.attcc.rds")
# phaseANDattention_interaction = readRDS("phaseANDattention_interaction.EEG.allsubs.attcc.rds")
# rewardTimesPhasePlusAtt = readRDS("rewardTimesPhasePlusAtt.EEG.allsubs.attcc.rds")
# full = readRDS("full.EEG.allsubs.attcc.rds")
# waic = readRDS("compare.EEG.waic.allsubs.attcc.rds")

# color_scheme_set("viridis")
# pp_check(full, type = "stat_grouped", nsamples = 100, group = "ExpPhase")

# WAIC
compare.EEG.waic.attcc = WAIC(null, expphase, attention, phaseANDattention, phaseANDattention_interaction, rewardTimesPhasePlusAtt, full, compare = TRUE)
saveRDS(compare.EEG.waic.attcc,file="compare.EEG.waic.allsubs.attcc.rds")
...
# saveRDS(compare.EEG.waic.weights,file="compare.EEG.waic.attcc.weights")

# Bayesian R2
#Null
bR2.null.EEG = bayes_R2(null)
saveRDS(bR2.null.EEG,file="bR2.null.attcc.EEG")
#ExpPhase
bR2.expphase.EEG = bayes_R2(expphase)
saveRDS(bR2.expphase.EEG,file="bR2.expphase.attcc.EEG")
#Attention
bR2.attention.EEG = bayes_R2(attention)
saveRDS(bR2.attention.EEG,file="bR2.attention.attcc.EEG")
#Phase and attention
bR2.phaseANDattention.EEG = bayes_R2(phaseANDattention)
saveRDS(bR2.phaseANDattention.EEG,file="bR2.phaseANDattention.attcc.EEG")
#Phase and attention interaction
bR2.phaseANDattention_interaction.EEG = bayes_R2(phaseANDattention_interaction)
saveRDS(bR2.phaseANDattention_interaction.EEG,file="bR2.phaseANDattention_interaction.attcc.EEG")
#Reward times phase plus attention
bR2.rewardTimesPhasePlusAtt.EEG = bayes_R2(rewardTimesPhasePlusAtt)
saveRDS(bR2.rewardTimesPhasePlusAtt.EEG,file="bR2.rewardTimesPhasePlusAtt.attcc.EEG")
#Full
bR2.full.EEG = bayes_R2(full)
saveRDS(bR2.full.EEG,file="bR2.full.attcc.EEG")
