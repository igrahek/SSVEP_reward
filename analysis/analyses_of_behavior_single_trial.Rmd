...
## Hits vs. all the other responses
### Means - Hit rates - raw data
...
model.full.Acc = readRDS("model.full.Cor.rds")
compare.waic.Acc = readRDS("compare.Acc.waic")
compare.Acc.waic.weights = readRDS("compare.Cor.waic.weights")
bR2.null.Acc = readRDS("bR2.null.Cor")
bR2.expphase.Acc = readRDS("bR2.expphase.Cor")
# bR2.full.Acc = readRDS("bR2.full.Cor")
```
