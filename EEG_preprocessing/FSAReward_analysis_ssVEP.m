...
Avg.pathssj = [pathanalysis 'movement\preproc\']; % where to retrieve the preprocessed individual subject data (for grand average)
Avg.pathGM = [pathanalysis 'movement\mean\']; % where to save the grand average
