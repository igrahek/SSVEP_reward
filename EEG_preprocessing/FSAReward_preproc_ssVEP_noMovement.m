...
% save log file
cd('E:\Experiments\Grahek_Ivan\FSAReward\repo\EEG_preprocessing\') % set current directory
...
head_summary = {'ssj' 'interp_chans' 'BslnRedAttended' 'BslnBlueAttended' 'AcqRedAttended' 'AcqBlueAttended' 'ExtRedAttended' 'ExtBlueAttended'}; % file header
summary = [head_summary; summary]; % merge header and data
cell2csv(['E:\Experiments\Grahek_Ivan\FSAReward\repo\EEG_preprocessing\' expname '_logfile_interp_artrej.csv'], summary); % save as .csv
