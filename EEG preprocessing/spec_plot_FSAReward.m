...
%             data_plot(counter,:)=[Avg.subjects(i_ssj),topo.freq(i_freq),topo.conds(i_cond),temp];
%             counter=counter+1;
%         end
%     end
% end
% % data_header=['participant','frequency','condition', num2cell(freqs)];
% % data_plot=[data_header;num2cell(data_plot)];
% % cell2csv('C:\Users\Antonio\Desktop\spectra.csv',data_plot);
% csvwrite('C:\Users\Antonio\Desktop\spectra.csv',data_plot);
